...
import { SpeechmaticsStreamClient } from './speechmatics.js';
...
export class AudioStreamManager {
    ...
    constructor(roomId, speechmaticsConfig, transcriptManager) {
        this.roomId = roomId;
        this.speechmaticsConfig = speechmaticsConfig;
        this.transcriptManager = transcriptManager;
    }
    async handleParticipantTrack(participant, track, participantId) {
        ...
        const client = new SpeechmaticsStreamClient(this.roomId, participantId, this.speechmaticsConfig, this.transcriptManager);
        try {
            await client.start();
    ...
    async handleParticipantDisconnected(participantIdentity) {
...
//# sourceMappingURL=audio-stream-manager.js.map