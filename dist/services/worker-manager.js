...
import { LiveKitRoomClient } from './livekit-room.js';
...
export class WorkerManager {
    ...
    async processRoom(room) {
        ...
        this.livekitClient = new LiveKitRoomClient(room.id, room.room_name, this.workerId, livekitConfig, this.audioStreamManager);
    ...
    async loadLiveKitConfig(serverId) {
        const supabase = getSupabase();
        const { data, error } = await supabase
